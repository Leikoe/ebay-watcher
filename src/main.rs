...
const QUERIES: [&str; 2] = [
    "nvidia (A100,A800,A100X,A800X,H100,H800,H200,B100,B200,PG530,PG520,PG,HBM3,HBM3e,PG199,DRIVE A100)",
    "amd (MI100,MI210,MI250,MI250X,MI300A,MI300X,MI325X,MI350X,MI355X,MI,HBM2e,HBM3,HBM3e,7A53)",
];
